...
<div class="nav-no-collapse header-nav">
	<ul class="nav pull-right">
		...
		<li class="dropdown">
			<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
				<img style=" height: 35px; width: 40px" src="{{URL::to("backend/img/Zillur1.png")}}" alt="">
...
<div class="alert alert-block span10">
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="#" alt="Bootstrap Themes">creativeLabs</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://sbit.com.bd" alt="Admin">SBIT</a></span>
		</p>
	...
	<script>
		$(document).on("click", "#delete", function(e){
			...
			bootbox.confirm("Are you want to deleted!!",function(confirmed){
				if(confirmed)
				{
