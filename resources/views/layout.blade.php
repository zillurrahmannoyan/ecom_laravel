...
<![endif]-->       
<link rel="shortcut icon" href="{{asset("frontend/images/home/sort_cart.png")}}">
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{URL::to("frontend/images/ico/apple-touch-icon-144-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{URL::to("frontend/images/ico/apple-touch-icon-114-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{URL::to("frontend/images/ico/apple-touch-icon-72-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" href="{{URL::to("frontend/images/ico/apple-touch-icon-57-precomposed.png")}}">
<!-- ManyChat -->
<script src="//widget.manychat.com/516156195540499.js" async="async"></script>
</head><!--/head-->
...
.paymentWrap .paymentBtnGroup .paymentMethod .method.visa {
    background-image: url("https://i.pointhacks.com/2015/11/15221845/Paypal-Logo-728x508.jpg");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.master-card {
    background-image: url("http://orignallogo.com/wp-content/uploads/2018/04/Mastercard-Logo-Icon-Vector-Free-Download.png");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.handcash {
    background-image: url("http://www.todayifoundout.com/wp-content/uploads/2017/10/wallet-full-of-money.png");
}
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +880 1865-664628</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> noyan@sdip.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-sm-3">
                    ...
                    <footer id="footer"><!--Footer-->
                        ...
                        <div class="footer-bottom">
                            <div class="container">
                                <div class="row">
                                    <p class="pull-left">© 2018 Zillur Rahman. All rights reserved.</p>
                                    <p class="pull-right">Designed by <span><a target="_blank" href="https://noyansandwip.blogspot.com/">NOYAN</a></span></p>
                                </div>
                            </div>
                        </div>
