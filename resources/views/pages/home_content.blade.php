                            ...
                            <div class="product-image-wrapper" style=" height: 300px">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to("$v_published_product->product_image")}}" style=" height: 100px; width: 100px" alt="" />
                                            <h2>{{$v_published_product->product_price}} TK</h2>
                                            <p>{{$v_published_product->product_name}}</p>
                                            <a href="#" class="btn btn-warning add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                    <div class="product-overlay">
                        <div class="overlay-content" style=" height: 200px">
                            <h2>{{$v_published_product->product_price}} TK</h2>
                            <a href="{{URL::to('/view_product/'.$v_published_product->product_id)}}"><p>{{$v_published_product->product_name}}</p></a>
                            <a href="{{URL::to('/view_product/'.$v_published_product->product_id)}}" class="btn btn-sm btn-warning add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
                    </div>
                                </div>
                                <div class="choose">
