				...
				<tbody>
					<tr>
						...
						<td style="height: 80px; width: 100px">
							<img src="{{URL::to($v_product->product_image)}}" alt="Img">
						</td>
						...
						<td class="center">
							...
							<a class="btn btn-danger" onclick="return confirm('Are you sure to Delete!')"  href="{{URL::to('/delete-product/'.$v_product->product_id)}}"  id="">
