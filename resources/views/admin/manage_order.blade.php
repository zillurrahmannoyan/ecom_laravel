				...
				<tbody>
					<tr>
						...
						<td class="center">
							...
							@else
							<a class="btn btn-success" href="{{URL::to('/ss/'.$v_order->order_id)}}">
							...
							<a class="btn btn-danger" onclick="return confirm('Are you sure to Delete!')"  href="{{URL::to('/delete/'.$v_order->order_id)}}"  id="">
